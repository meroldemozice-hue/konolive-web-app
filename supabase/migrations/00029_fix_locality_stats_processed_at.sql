-- Update public dashboard and internal extra stats to correctly count processed_at for today
...
BEGIN
  ...
  FROM (
    SELECT 
      ...
      COUNT(r.id) FILTER (WHERE r.created_at >= current_date) as received,
